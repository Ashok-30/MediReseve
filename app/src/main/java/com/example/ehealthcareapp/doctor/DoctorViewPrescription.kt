...
import com.example.ehealthcareapp.doctor.adapter.PrescriptionAdapter
...
class DoctorViewPrescription : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.doctor_viewprescription)
        ...
        dbRef.child("Booking").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                override fun onDataChange(doctorSnapshot: DataSnapshot) {
                                    ...
                                    dbRef.child("Doctors").child(booking.doctorId).addListenerForSingleValueEvent(object : ValueEventListener {
                                        override fun onDataChange(patientSnapshot: DataSnapshot) {
                                            ...
                                            val adapter = PrescriptionAdapter(filteredBookings)
                ...
                if (!openAppointmentFound) {
                    val alertDialogBuilder = AlertDialog.Builder(this@DoctorViewPrescription)


                    alertDialogBuilder.setTitle("Prescriptions Alert")
                    alertDialogBuilder.setMessage("No Appointments to give prescription")

//                    alertDialogBuilder.setPositiveButton("Okay") { dialog, which ->
//
//                        val intent = Intent(this@DoctorViewPrescription, DoctorHomeScreenActivity::class.java)
...
//                    }
                    ...
                    alertDialog.setOnShowListener {
                        ...
                        button.setTextColor(ContextCompat.getColor(this@DoctorViewPrescription, R.color.white))
                        button.setBackgroundColor(ContextCompat.getColor(this@DoctorViewPrescription, R.color.button))
                    }
        ...
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.nav_logout -> {
                    ...
                    val intent = Intent(this@DoctorViewPrescription, MainActivity::class.java)
                    startActivity(intent)
                    finish()
                }
